...
\item Los datos con procedencia, crudos, versiones, pruebas y comandos permiten repetir el experimento. Los estudiantes deben ejecutar la demo en su PC y crear los commits reales antes de publicar el repositorio.
\end{enumerate}

\titulo{9. Declaración de uso de IA}
Se utilizó ChatGPT para estructuración, apoyo de programación, revisión y documentación. Las implementaciones y resultados se sometieron a pruebas y ejecución en Work. No se afirma escritura manual por los integrantes ni ejecución previa en su PC. Corresponde a los estudiantes revisar, comprender y reproducir el trabajo antes de entregarlo.
